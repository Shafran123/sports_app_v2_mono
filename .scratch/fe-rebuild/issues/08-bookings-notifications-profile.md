# 08 — Bookings, notifications, profile

**What to build:** the Player's account surfaces — booking history with actions, a notification center, and profile editing — all live and production-grade.
...
- [ ] Profile: edit name/phone/city with inline validation, save with success/error feedback, logout
- [ ] Build green