...
**What to build:** a Player can discover, open, and register for events — and an organizer can cancel one — with the same production-grade treatment as the booking flow.
